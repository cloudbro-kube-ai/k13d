...
[Release v1.1.0](https://github.com/cloudbro-kube-ai/k13d/releases/tag/v1.1.0) 페이지의 **Assets** 에서 내 OS / CPU 에 맞는 파일을 선택하세요.
전체 릴리즈와 자산 목록은 [GitHub Releases 페이지](https://github.com/cloudbro-kube-ai/k13d/releases) 에서 확인할 수 있습니다.

- macOS Apple Silicon: `k13d_v1.1.0_darwin_arm64.tar.gz`
- macOS Intel: `k13d_v1.1.0_darwin_amd64.tar.gz`
- Linux x86_64: `k13d_v1.1.0_linux_amd64.tar.gz`
- Linux arm64: `k13d_v1.1.0_linux_arm64.tar.gz`
- Windows x86_64: `k13d_v1.1.0_windows_amd64.zip`
...
- **4가지 Theme** — Tokyo Night, Production, Staging, Development
