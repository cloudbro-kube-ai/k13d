...
=== "1. Download"
    ...
    Download the matching asset from [Release v1.1.0](https://github.com/cloudbro-kube-ai/k13d/releases/tag/v1.1.0).
    ...
    - Linux amd64: `k13d_v1.1.0_linux_amd64.tar.gz`
    - Linux arm64: `k13d_v1.1.0_linux_arm64.tar.gz`
    - Windows amd64: `k13d_v1.1.0_windows_amd64.zip`
